...
- Output Formats:
   - Confirmation: Clear event details with time, location, attendees.  
   - Options: Multiple time slots with pros/cons.  
   - Insights: Weekly/monthly scheduling analysis.  
   - Alerts: Proactive notifications about conflicts or opportunities.
